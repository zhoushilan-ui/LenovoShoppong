$(function() {
	$(".btn_login").click(function() {
		...
		var loginUser = $(".content_one input.login_number").val();
		var loginPassword = $(".content_one input.login_password").val();
		console.log(loginUser);
		console.log(loginPassword);
		if (loginUser == userAll.username && loginPassword == userAll.password) {
			alert('登陆成功!');
